                    ...
                    <div className="glass-portal rounded-full w-full max-w-[680px] aspect-square flex flex-col items-center justify-center text-center px-8 md:px-16 py-16 relative group transition-all duration-500 hover:shadow-[0_0_120px_rgba(37,19,236,0.3)]">
                        ...
                        <div className="flex flex-col gap-4 w-full max-w-[400px] relative z-50">
                            <button
                                ...
                                className="group flex items-center justify-center gap-4 w-full h-16 rounded-2xl bg-white text-background-dark text-lg font-[800] hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] transition-all transform hover:-translate-y-1 active:scale-[0.98] cursor-pointer relative"
                            >
                                <svg className="size-6 transition-transform group-hover:scale-110" viewBox="0 0 24 24">
