...
const Challenges = () => {
    ...
    return (
        <div className="flex flex-col xl:flex-row gap-8 w-full relative transition-colors">
            {/* Toast Notification */}
            {showToast && (
                <div className="fixed top-24 right-8 bg-gray-900 dark:bg-gray-800 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 z-50 animate-bounce border border-gray-700">
            ...
            <div className="flex-1 flex flex-col gap-8 min-w-0">
                ...
                <div className="w-full bg-[#111322] rounded-3xl p-8 relative overflow-hidden shadow-lg border border-gray-800">
                    ...
                    <div className="absolute top-0 right-0 w-2/3 h-full bg-gradient-to-l from-indigo-900/20 to-transparent pointer-events-none"></div>
                    <div className="absolute -top-32 -right-16 w-96 h-96 bg-primary/20 rounded-full blur-[100px] pointer-events-none"></div>
                    ...
                    <div className="relative z-10 w-full max-w-2xl">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="bg-primary text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full">Featured Challenge</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-8">
                            <div className="flex gap-4">
                                <div className="flex flex-col items-center">
                                    ...
                                    <span className="text-[10px] text-gray-400 mt-2 font-bold uppercase tracking-widest">Days</span>
                                </div>
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <span className="text-[10px] text-gray-400 mt-2 font-bold uppercase tracking-widest">Hours</span>
                                </div>
                                <div className="text-white/30 font-bold text-xl mt-3">:</div>
                                <div className="flex flex-col items-center">
                                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 flex flex-col items-center justify-center min-w-[3.5rem] border border-white/5">
                                    ...
                                    <span className="text-[10px] text-gray-400 mt-2 font-bold uppercase tracking-widest">Mins</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <button 
                            ...
                            className="bg-primary hover:bg-indigo-600 hover:scale-[1.02] active:scale-[0.98] transition-all text-white font-bold py-3.5 px-8 rounded-xl shadow-lg shadow-primary/30 flex items-center gap-2 group"
                        >
                            Register Now
                ...
                <div className="w-full space-y-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            ...
                            {['Live', 'Upcoming', 'Past'].map((tab) => (
                                <button
                                    ...
                                    className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${
                                        activeTab === tab 
                                            ? 'bg-white dark:bg-gray-700 text-primary dark:text-indigo-400 shadow-sm' 
                                            : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white hover:bg-white/50 dark:hover:bg-gray-700/50'
                                    }`}
                                >
                                    {tab}
                                </button>
                        ...
                        <div className="flex items-center gap-2 text-sm">
                            ...
                            <button className="flex items-center gap-1 text-gray-900 dark:text-white font-bold hover:text-primary dark:hover:text-indigo-400 transition-colors">
                                Ending Soon
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-8">
                        {filteredChallenges.length > 0 ? filteredChallenges.map((challenge) => (
                            <div key={challenge.id} className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden group hover:shadow-xl hover:shadow-primary/5 hover:border-primary/20 dark:hover:border-indigo-500/50 transition-all cursor-pointer flex flex-col h-full">
                                <div className={`h-40 bg-gradient-to-br ${challenge.bgGradient} relative overflow-hidden shrink-0`}>
                                    ...
                                    <div className="absolute top-4 left-4 bg-white dark:bg-gray-900 rounded-full px-3 py-1 flex items-center gap-2 shadow-md">
                                        <div className={`size-4 rounded-full bg-${challenge.color}-500`}></div>
                                        <span className="text-[10px] font-bold text-gray-900 dark:text-white uppercase tracking-wide">{challenge.company}</span>
                                    </div>
                                </div>
                                <div className="p-6 flex-1 flex flex-col">
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-primary dark:group-hover:text-indigo-400 transition-colors line-clamp-1">{challenge.title}</h3>
                                    <p className="text-gray-500 dark:text-gray-400 leading-relaxed text-sm mb-6 line-clamp-2">{challenge.desc}</p>
                                    ...
                                    <div className="mt-auto space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center justify-between text-xs font-bold">
                                                <span className={challenge.status === 'Live' ? 'text-primary dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'}>{challenge.timeInfo}</span>
                                                <span className="text-gray-400 dark:text-gray-500 uppercase tracking-wider">{challenge.progress}% Complete</span>
                                            </div>
                                            <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
                                                <div className={`h-full rounded-full relative ${challenge.progress === 100 ? 'bg-green-500' : 'bg-primary dark:bg-indigo-500'}`} style={{ width: `${challenge.progress}%` }}></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-span-1 md:col-span-2 text-center py-12 bg-gray-50 dark:bg-gray-800/50 rounded-3xl border border-gray-100 dark:border-gray-700 border-dashed">
                                <span className="material-symbols-outlined text-gray-300 dark:text-gray-600 text-[48px] mb-4">sentiment_dissatisfied</span>
                                <h3 className="text-gray-500 dark:text-gray-400 font-bold">No {activeTab.toLowerCase()} challenges found.</h3>
                            </div>
                        )}
                    </div>
                </div>
            ...
            <div className="w-full xl:w-[340px] shrink-0 space-y-6">
                ...
                {/* Winner Spotlight */}
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm relative overflow-hidden group transition-colors">
                    <div className="flex items-center gap-2 mb-6">
                        <span className="material-symbols-outlined text-yellow-500">emoji_events</span>
                        <h3 className="font-bold text-gray-900 dark:text-white">Winner Spotlight</h3>
                    </div>

                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-6 flex flex-col items-center text-center border border-gray-100 dark:border-gray-600 group-hover:bg-primary/5 dark:group-hover:bg-indigo-900/30 transition-colors">
                        ...
                        <h4 className="font-bold text-gray-900 dark:text-white text-lg">Mark Mukerburg</h4>
                        <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mt-1 mb-6">Winner: Python Data Sprint #42</p>

                        <button className="w-full bg-[#EFEFFC] dark:bg-indigo-900/40 hover:bg-primary hover:text-white dark:hover:bg-indigo-600 transition-colors text-primary dark:text-indigo-400 font-bold py-3 rounded-xl flex items-center justify-center gap-2 text-sm shadow-sm group/btn">
                            View Project
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button className="text-primary dark:text-indigo-400 text-xs font-bold hover:underline uppercase tracking-wide">View All</button>
                    </div>

                    <div className="space-y-4">
                        {/* Player 1 */}
                        <div className="flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors border border-transparent hover:border-gray-100 dark:hover:border-gray-600 -mx-3 cursor-pointer">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 dark:text-white text-sm leading-tight">Alex Chen</h4>
                                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider mt-0.5">12 WINS</p>
                                </div>
                            </div>
                            <div className="text-primary dark:text-indigo-400 font-black text-sm text-right">
                                5,200 XP
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors border border-transparent hover:border-gray-100 dark:hover:border-gray-600 -mx-3 cursor-pointer">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 dark:text-white text-sm leading-tight">Mark Z.</h4>
                                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider mt-0.5">9 WINS</p>
                                </div>
                            </div>
                            <div className="text-primary dark:text-indigo-400 font-black text-sm text-right">
                                4,850 XP
                        ...
                        <div className="flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors border border-transparent hover:border-gray-100 dark:hover:border-gray-600 -mx-3 cursor-pointer">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 dark:text-white text-sm leading-tight">Sarah L.</h4>
                                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider mt-0.5">7 WINS</p>
                                </div>
                            </div>
                            <div className="text-primary dark:text-indigo-400 font-black text-sm text-right">
                                4,120 XP
                ...
                <div className="bg-primary rounded-3xl p-8 relative overflow-hidden shadow-lg shadow-primary/20 text-white">
                    ...
                    <div className="relative z-10 flex flex-col items-start gap-4">
                        ...
                        <button className="w-full bg-white text-primary font-bold py-3.5 rounded-xl shadow-md hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all">
                            Get Started
                        </button>
                    </div>
                </div>
