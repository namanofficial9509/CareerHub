        ...
        <div className="max-w-[1400px] mx-auto space-y-6 pb-20">
            ...
            {activeTab === 'feed' && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm flex items-center justify-between transition-colors">
                        <div>
                            <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2">Current Track</p>
                            <h3 className="text-xl font-[900] text-gray-900 dark:text-white">Product Management</h3>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm flex items-center justify-between transition-colors">
                        <div>
                            <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2">Active Circles</p>
                            <h3 className="text-xl font-[900] text-gray-900 dark:text-white">12 Communities</h3>
                        </div>
                        <div className="text-right">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm flex items-center justify-between transition-colors">
                        <div>
                            <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2">Weekly Engagement</p>
                            <h3 className="text-xl font-[900] text-gray-900 dark:text-white">85% Score</h3>
                        </div>
                        <div className="text-right">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-2 space-y-6">
                    {/* Tabs */}
                    <div className="bg-white dark:bg-gray-800 p-2 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm inline-flex gap-2 transition-colors">
                        {[
                            ...
                            <button
                                ...
                                className={`px-6 py-3 rounded-xl flex items-center gap-2 text-sm font-bold transition-all ${activeTab === tab.id
                                    ? 'bg-blue-600 dark:bg-blue-500 text-white shadow-lg shadow-blue-500/30 dark:shadow-none'
                    ...
                    {activeTab === 'feed' && (
                        <div className="space-y-6">
                            {/* Post 1 */}
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900 dark:text-white">Liam Carter</h4>
                                            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Sophomore • CS @ Stanford</p>
                                        </div>
                                    </div>
                                ...
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Advice on landing a first PM internship?</h3>
                                ...
                                <div className="flex gap-2 mb-6">
                                    <span className="bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs font-bold px-3 py-1.5 rounded-lg">#ProductManagement</span>
                                    <span className="bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs font-bold px-3 py-1.5 rounded-lg">#Networking</span>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900 dark:text-white">Jamie Chen</h4>
                                            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Senior • Data Science</p>
                                        </div>
                                    </div>
                                    <span className="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-[10px] font-bold px-2 py-1 rounded-lg uppercase tracking-wider">Resource</span>
                                </div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Free SQL Mastery Guide for Interviews</h3>
                    ...
                    {activeTab === 'circles' && (
                        <div className="space-y-8">
                            <div>
                                <h2 className="text-2xl font-[900] text-gray-900 dark:text-white">Goal Circles Workspace</h2>
                                <p className="text-gray-500 font-medium text-sm dark:text-gray-400">Welcome back, {userData?.fullName ? userData.fullName.split(' ')[0] : user?.displayName?.split(' ')[0] || 'User'}! You have 2 circles needing updates today.</p>
                            </div>

                            {/* Active Commitments */}
                            <div className="space-y-4">
                                <h3 className="font-bold text-gray-900 dark:text-white">Active Commitments</h3>
                                    ...
                                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="flex gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-gray-900 dark:text-white">DSA 60-day grind</h4>
                                                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Day 14 of 60 • Next sync: 8 PM</p>
                                                </div>
                                            </div>
                                        ...
                                        <button className="w-full py-2.5 bg-white dark:bg-gray-800 border-2 border-blue-600 dark:border-blue-500 text-blue-600 dark:text-blue-400 font-bold rounded-xl text-sm hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors">
                                            Update Progress
                                        </button>
                                    </div>
                                    ...
                                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="flex gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-gray-900 dark:text-white">UI/UX Portfolio Builders</h4>
                                                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Next Critique: Thursday</p>
                                                </div>
                                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center">
                                    <h3 className="font-bold text-gray-900 dark:text-white">Discover New Circles</h3>
                                    <div className="flex gap-2">
                                        <button className="px-3 py-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-xs font-bold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">Trending</button>
                                        <button className="px-3 py-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-xs font-bold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">New</button>
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    {[
                                        ...
                                        <div key={i} className="bg-white dark:bg-gray-800 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden group transition-colors">
                                            <div className="h-32 bg-gray-200 dark:bg-gray-700 relative transition-colors">
                                                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                                                <span className="absolute bottom-3 left-3 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-[10px] font-black px-2 py-0.5 rounded uppercase tracking-wider">{circle.label}</span>
                                            </div>
                                            <div className="p-4">
                                                <h4 className="font-bold text-gray-900 dark:text-white mb-1">{circle.title}</h4>
                                                <div className="flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400 font-medium mb-3">
                                                ...
                                                <div className="flex items-center justify-between mb-4">
                                                    ...
                                                    <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase">{circle.level}</span>
                                                </div>
                    ...
                    {activeTab === 'alumni' && (
                        <div className="space-y-8">
                            ...
                            {/* Search */}
                            <div className="flex gap-4">
                                <div className="flex-1 bg-gray-50 dark:bg-gray-800 rounded-xl px-4 py-3 flex items-center gap-2 border border-gray-100 dark:border-gray-700 focus-within:ring-2 focus-within:ring-blue-500/20 dark:focus-within:ring-blue-400/20 transition-all">
                                ...
                                <div className="flex gap-2">
                                    {['Tech', 'Finance', 'Creative', 'Healthcare'].map(filter => (
                                        <button key={filter} className="hidden md:flex px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl text-sm font-bold text-gray-600 dark:text-gray-300 items-center justify-between gap-2 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                            {filter}
                                        </button>
                                    ))}
                                </div>
                                    ...
                                    <div key={i} className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-all">
                                        <div className="flex justify-between items-start mb-6">
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-gray-900 dark:text-white text-lg leading-tight">{alum.name}</h4>
                                                    <p className="text-sm font-bold text-blue-600 dark:text-blue-400">{alum.role}</p>
                                                    <div className="flex items-center gap-1 text-xs font-bold text-gray-400 dark:text-gray-500 mt-1 uppercase tracking-wider">
                                                        <CheckCircle2 className="size-3 text-blue-500" /> {alum.company}
                                                    </div>
                                                </div>
                                            </div>
                                            <button className="size-10 rounded-xl bg-gray-50 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-white transition-colors">
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-300 italic mb-6">"{alum.quote}"</p>
                                            ...
                                            <div className="flex justify-between relative z-10">
                                                {alum.path.map((step, idx) => (
                                                    <div key={idx} className="flex flex-col items-center gap-2">
                                                        ...
                                                        <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">{step}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>

                                        <button className="w-full mt-6 py-2.5 bg-blue-600 dark:bg-blue-500 text-white font-bold rounded-xl text-sm shadow-lg shadow-blue-500/20 dark:shadow-none hover:bg-blue-700 dark:hover:bg-blue-600 transition-all">
                                            View Journey
                                        </button>
                                    </div>
                                ))}
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                {[
                                    ...
                                    <div key={i} className="bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center justify-between hover:border-blue-200 dark:hover:border-blue-500/50 transition-colors group cursor-pointer">
                                        <div className="flex items-center gap-4">
                                            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-xl text-center min-w-[60px]">
                                                <span className="block text-xs font-bold text-red-500 dark:text-red-400 uppercase">{event.date.split(' ')[0]}</span>
                                                <span className="block text-xl font-[900] text-gray-900 dark:text-white">{event.date.split(' ')[1]}</span>
                                            </div>
                                            <div>
                                                <h4 className="font-bold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{event.title}</h4>
                                        ...
                                        <button className="size-10 rounded-xl bg-gray-50 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 opacity-0 group-hover:opacity-100 transition-all hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400">
                ...
                <div className="space-y-6 lg:sticky lg:top-24">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                        ...
                        <div className="space-y-3">
                            <button className="w-full py-3 bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white font-bold rounded-xl shadow-lg shadow-blue-500/30 dark:shadow-none transition-all flex items-center justify-center gap-2">
                                <Plus className="size-4" /> Join New Circle
                            </button>
                            <button 
                                onClick={() => setIsShareModalOpen(true)}
                                className="w-full py-3 bg-white dark:bg-gray-800 border-[1px] border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-bold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all flex items-center justify-center gap-2"
                            >
                    ...
                    <div className="bg-gray-900 dark:bg-gray-800 p-6 rounded-[2rem] shadow-xl text-white relative overflow-hidden border border-transparent dark:border-gray-700 transition-colors">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="font-bold text-gray-900 dark:text-white">Trending Alumni</h3>
                            ...
                            {[
                                ...
                                <div key={i} className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500">{alumni.role}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    {/* Popular Circles */}
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                        <h3 className="font-bold text-gray-900 dark:text-white mb-4">Popular Circles</h3>
                        <div className="space-y-4">
                            {[
            ...
            {isShareModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    {/* Modal Content */}
                    <div className="relative bg-white dark:bg-gray-800 w-full max-w-xl rounded-[2.5rem] shadow-2xl shadow-gray-900/20 overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-10 duration-500 border border-gray-100 dark:border-gray-700">
                        {/* Header */}
                        <div className="p-8 pb-4 flex items-center justify-between">
                            <h3 className="text-2xl font-[900] text-gray-900 dark:text-white tracking-tight">Share New Insight</h3>
                            <button 
                                onClick={() => setIsShareModalOpen(false)}
                                className="size-10 rounded-full bg-gray-50 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-white transition-all"
                            >
                        ...
                        <div className="px-8 py-4">
                            <div className="flex gap-4 items-center mb-6">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 dark:text-white">{userData?.fullName || user?.displayName || 'User'}</h4>
                                </div>
                            </div>
                        ...
                        <div className="p-8 pt-4 flex flex-col sm:flex-row items-center justify-between gap-6">
                            <div className="flex gap-2 w-full sm:w-auto">
                                {[
                                    ...
                                    { icon: Code2, label: 'File', color: 'text-indigo-500 bg-indigo-50 dark:bg-indigo-900/30' }
                                ].map((btn, i) => (
                                    <button 
                                        key={i}
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-black uppercase tracking-widest hidden sm:inline">{btn.label}</span>
                                    </button>
                                ))}
                            </div>
                            ...
                            <button 
                                ...
                                className="w-full sm:w-auto px-8 py-3.5 bg-blue-600 dark:bg-blue-500 text-white font-black text-[14px] rounded-xl shadow-lg shadow-blue-500/30 dark:shadow-none hover:bg-blue-700 dark:hover:bg-blue-600 transition-all flex items-center justify-center gap-2"
                            >
                                <Zap className="size-4 fill-current" />
                                Post Insight
                            </button>
